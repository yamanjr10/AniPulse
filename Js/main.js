...
function startAnimationsAfterLoader() {
  ...
  setTimeout(() => {
    ...
    if (overviewSection) {
      ...
      // Animate them back up
      setTimeout(() => {
        animateCount(document.getElementById("completed-count"), completed, 4500);
        animateCount(document.getElementById("movies-count"), movies, 4500);
        animateCount(document.getElementById("episodes-count"), episodes, 4500);
        animateCount(document.getElementById("total-hours-count"), hours, 4500);
      }, 400);
    }
  }, 100);
    ...
    if (progress >= 100) {
      ...
      setTimeout(() => {
        ...
        setTimeout(() => {
          ...
          // 🎬 START ANIMATIONS AFTER LOADER COMPLETES
